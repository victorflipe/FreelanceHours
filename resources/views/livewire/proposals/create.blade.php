<div>
    ...
    <button
        class="bg-[#5354FD] text-white font-bold tracking-wide uppercase w-[16rem] py-3 rounded-[4px] hover:bg-[#1f20a6] transition duration-300 ease-in-out"
    ...
    <x-ui.modal>
        ...
        <form action="flex flex-col gap-6" wire:submit="save">
            ...
            <div class="mb-6">
                ...
                <div class="text-[16px] text-[#C3C3D1] mb-2">Faça sua oferta em horas mensais que você pode contribuir
                    com o
                    projeto.
                </div>
            </div>
            <div class="flex gap-4">
                <div class="w-2/3 gap-2 flex flex-col">
                    ...
                    <input wire:model="email" type="email"
                        class="w-full h-[52px] bg-[#1E1E2C] text-white p-3 focus:outline-none focus:ring-0 border border-[#1E1E2C]"
